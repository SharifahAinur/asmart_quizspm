...
<table width='100%' border='1' id='besar'>
    ...
    <!-- borang untuk mendaftar kelas baru -->
        <form name='tambah_kelas' action='' method='POST'>
            <td><input type='text' name='ting'></td>
            <td><input type='text' name='nama_kelas'></td>
            
            <td>
            <select name='nokp_guru'>
...
| <button onclick=\"location.href='padam.php?jadual=kelas&medan=id_kelas&kp=".$data['id_kelas']."'\" type='button'>Padam Kelas</button>|
